...
def home():
    if request.method == 'POST':
        if not request.form['principleAmount']:
            ...
            return render_template("index.html", stocksInput=stocksInput, ptype="submitted", sharesMin=sharesMin, sharesSharpe=sharesSharpe, sharesBench=sharesBench, )
    else:
